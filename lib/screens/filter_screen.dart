...
class _FilterScreenState extends State<FilterScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      ).onTap(() => context.go(locationsScreen)),
          ...
          children: [
                ...
                itemBuilder: (context, i) {
                  return Container(
                    ...
                    decoration: boxDecorationRoundedWithShadow(16,
                        backgroundColor:
                            isSelected == i ? primaryColor1 : white),
                    child: Text(filterDateList[i].name!,
                  ...
                  return Container(
                    ...
                    decoration: boxDecorationWithRoundedCorners(
                        ...
                        backgroundColor: filterHashtagList[i].isSelected == true
                            ? primaryColor1
                            : white),
                    child: Text(filterHashtagList[i].name!,
                        style: primaryTextStyle(
            ...
            createRichText(
              list: [
                ...
                TextSpan(
                    text: '${_value.toStringAsFixed(0)} mil',
